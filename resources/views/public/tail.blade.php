	...
	<body>
		<div class="left">
			<div class="bigTitle">商品后台管理系统</div>
			<div class="lines">
				<div onclick="pageClick(this)" class="active"><img src="img/icon-1.png" />业务人员管理</div>
				<div onclick="pageClick(this)"><img src="img/icon-2.png" /><a href="/admin/add">代理商品管理</a></div>
				...
				<div onclick="pageClick(this)"><img src="img/icon-5.png" /><a href="{{/con/add}}">普通商品添加</a></div>
			</div>
		</div>
