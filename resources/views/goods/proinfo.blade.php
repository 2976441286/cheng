			...
			<div class="content">
				<div class="cart-1">
					<div class="row">
						...
						<div class="col s7">
						<img src="{{$v->goods_img}}"  width="10" height="200"/>
						</div>
					</div>
					...
					<div class="row">
						<div class="col 12">
							<button class="btn button-default" id='sub'>SEND TO CART[发送到购物车]</button>
						</div>
					</div>
				</div>
				...
				<form action="{{url('con_add')}}" method="post">
					<table border="1">
						<tr>
						...
						<tr>
							<td>评论等级:
								<input type="text" name="dio" value="">
							</td>
						</tr>
						<tr>	<td>评论内容:	<input type="text"name="con"></td></tr>
						<tr>
